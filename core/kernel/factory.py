...
from core.kernel.types.descriptors import (
    ...
    BOOL_DESCRIPTOR, VOID_DESCRIPTOR, ANY_DESCRIPTOR, AUTO_DESCRIPTOR, CALLABLE_DESCRIPTOR, LIST_DESCRIPTOR,
...
def create_default_registry() -> MetadataRegistry:
    ...
    for d in (INT_DESCRIPTOR, STR_DESCRIPTOR, FLOAT_DESCRIPTOR,
              ...
              AUTO_DESCRIPTOR, CALLABLE_DESCRIPTOR, LIST_DESCRIPTOR, DICT_DESCRIPTOR,

...
from ..specs import (
    ...
    VECTOR_SPEC, KNOWLEDGE_SPEC, MEMORY_SPEC,
    LLM_CALL_RESULT_SPEC, LLM_UNCERTAIN_SPEC, INTENT_SPEC, INTENT_CONTEXT_SPEC, ENVIRONMENT_SPEC,
    RUN_RESULT_SPEC, QUOTED_SPEC, NARROW_MODEL_SPEC,
    LLM_ERROR_SPEC, LLM_PARSE_ERROR_SPEC, LLM_RETRY_EXHAUSTED_ERROR_SPEC, LLM_CALL_ERROR_SPEC,
    THREAD_ERROR_SPEC, THREAD_CANCELLED_SPEC, THREAD_FAILED_SPEC,
...
def create_default_spec_registry(axiom_registry: "AxiomRegistry") -> "SpecRegistry":
    ...
    for proto in (
        ...
        ENUM_SPEC, LLM_CALL_RESULT_SPEC, LLM_UNCERTAIN_SPEC, INTENT_SPEC, INTENT_CONTEXT_SPEC, ENVIRONMENT_SPEC,
    VECTOR_SPEC, KNOWLEDGE_SPEC, MEMORY_SPEC, RUN_RESULT_SPEC, QUOTED_SPEC, NARROW_MODEL_SPEC,
    LLM_ERROR_SPEC, LLM_PARSE_ERROR_SPEC, LLM_RETRY_EXHAUSTED_ERROR_SPEC, LLM_CALL_ERROR_SPEC,
    THREAD_ERROR_SPEC, THREAD_CANCELLED_SPEC, THREAD_FAILED_SPEC,

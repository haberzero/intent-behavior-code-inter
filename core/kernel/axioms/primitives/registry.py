...
from core.kernel.axioms.primitives.generator import GeneratorAxiom
...
from core.kernel.axioms.primitives.memory import MemoryAxiom
...
from core.kernel.axioms.primitives.narrow_model import NarrowModelAxiom
...
def register_core_axioms(registry: "AxiomRegistry") -> None:
    ...
    registry.register(ThreadErrorAxiom())
    registry.register(ThreadCancelledAxiom())
    registry.register(ThreadFailedAxiom())
    ...
    registry.register(VectorAxiom())
    registry.register(KnowledgeAxiom())
    registry.register(MemoryAxiom())
    ...
    registry.register(NarrowModelAxiom())
    ...
    registry.register(GeneratorAxiom())

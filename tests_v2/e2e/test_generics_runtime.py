"""
tests_v2/e2e/test_generics_runtime.py — 泛型运行时黑盒回归。

自 tests/compiler/test_generics.py 拆分（mixed-concerns）：完整程序执行用例归
e2e/（含类内少量 compile-only 校验）；纯编译期契约归 tests_v2/compiler/test_generics.py。
"""
from core.kernel.factory import create_default_registry
from core.kernel.issue import CompilerError
from core.kernel.spec import SpecRegistry, TypeDef
from tests_v2.conftest import compile_ibci, run_ibci

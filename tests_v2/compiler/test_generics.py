"""
tests_v2/compiler/test_generics.py — 泛型编译期契约（compile-only）。
...
运行时执行用例见 tests_v2/e2e/test_generics_runtime.py（mixed-concerns 拆分）。
"""
from core.kernel.factory import create_default_registry
from core.kernel.issue import CompilerError
from core.kernel.spec import SpecRegistry, TypeDef
from tests_v2.conftest import compile_ibci, expect_compile_error

...
> 本文档是 2026-05-27 命名模型路由（`@NAME~`）实现当天的决策现场便签。
> 其全部决策点**已被正式 ADR 承接**：R1/R3/R4 → `docs/decisions/ADR-008`；R5 → `docs/decisions/ADR-010`。
> 保留于 `docs/archive/` 仅供考古。文中的"尚未实现/待办"陈述均已落地，请勿据此判断当前状态。

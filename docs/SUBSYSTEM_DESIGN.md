...
| 02 | [02_file_container](subsystems/02_file_container.md) | 文件容器与磁盘型存储 | 协议族、Backing 模型、类型继承、fs 模块、LLM 交互 |
...
| 05 | [05_coroutine](subsystems/05_coroutine.md) | 协程层设计 | 调度器多任务化与 await/生成器执行模型概述 |

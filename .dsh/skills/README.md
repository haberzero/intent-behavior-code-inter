...
| `code-quality` | 质量底线与健康诊断（红线 + 十查 + 分类处置） | 兜底/兼容层/历史包袱/双通道/双写真相判定、健康体检 |
| `code-odor` | 异味特征检测 + 工作过程自查 + 自我质询协议 | 嵌套分支/兼容/兜底/快速实现等字样、反射/能力探测隐蔽变体扫描 |
| `self-grill` | 自我质询：逐项找不清晰/未决断项，仅上报待决断 | 自查/内审/还有哪些没想清楚 |

...
- **成因**：2026-08-09 三轴盘点登记；阶段 E（宣发前置）文档旅程项的一部分。
...
- **动机**：理论问题清理完毕后进入宣发/推广（阶段 E）——运行期真实场景基准、
  调试器断点/单步、包管理等宣发最小集。范围与节奏待用户确认
  （准备性评估：E1 运行期基准缺失 / E2 断点调试器缺失 / E3 文档旅程已具雏形 /
  E4 版本 0.2.0→0.3.0 待评估）。

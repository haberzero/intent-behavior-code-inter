...
class TestMetadataRegistry(unittest.TestCase):
    ...
    def test_resolve_with_module_path(self):
        """测试带模块路径的解析"""
        desc = self.registry.resolve("int", module_path="core.kernel")
...
class TestTypeFactory(unittest.TestCase):
    ...
    def test_create_primitive(self):
        """测试创建原始类型"""
        factory = self.registry._factory
    ...
    def test_create_list(self):
        ...
        self.assertIsNotNone(desc._element_type)
    ...
    def test_create_dict(self):
        ...
        self.assertIsNotNone(desc._key_type)
        self.assertIsNotNone(desc._value_type)

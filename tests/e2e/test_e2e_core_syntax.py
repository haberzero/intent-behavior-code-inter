...
# Note: ``TestE2EStringMethods`` renamed to ``TestE2EStringMethodsAdvanced`` to
# avoid collision with the existing class of the same name above.
################################################################################
...
class TestE2EStringMethodsAdvanced:

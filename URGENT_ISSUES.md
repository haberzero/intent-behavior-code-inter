...
> 状态：⚠️ 待修复 / ✅ 已修复
>
> **当前状态（2026-04-28）**：高优 H1/H2/H3 ✅ + 中优 M1/M2/M3/M4/M5 ✅ 全部修复。L1–L4 维护性改善已搬到 [`docs/DEFERRED_CLEANUP.md`](DEFERRED_CLEANUP.md)（含已识别可清理的兼容性回退条目），等待下一个独立 PR 处理。本文件保留作为修复历史归档。
